...
_NAM.CFG_CONFIRM_REPLACE_FROM_BACKUP = "confirm-replace-from-backup";
_DEF[_NAM.CFG_CONFIRM_REPLACE_FROM_BACKUP] = true;
_VAL[_NAM.CFG_CONFIRM_REPLACE_FROM_BACKUP] = _vbool;

_NAM.CFG_CONFIRM_CLOSE_ALL_AND_SAVE = "confirm-close-all-and-save";
_DEF[_NAM.CFG_CONFIRM_CLOSE_ALL_AND_SAVE] = true;
_VAL[_NAM.CFG_CONFIRM_CLOSE_ALL_AND_SAVE] = _vbool;
